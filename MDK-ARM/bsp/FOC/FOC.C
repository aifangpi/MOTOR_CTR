...
void setPhaseVoltage(float Uq, float Ud, float angle_el)
{
	...
	if(Ud)//¦Ì¡ÀUqo¨ªUd??¨®DD¡ì¨º¡À
	{
		// ¨º1¨®?¨°????¨¹??¦Ì???¡¤??¨´????Uout
		Uout = _sqrtApprox(Ud*Ud + Uq*Uq) / voltage_power_supply;
		//???¨¨1¨¦¨°??¡¥¡ê?¡Áa?¡¥¦Ì????¨¨??¡ê¡§0-2pi¡ê?
...
__HAL_TIM_SetCompare(&htim1,TIM_CHANNEL_1,Ta*4250);
__HAL_TIM_SetCompare(&htim1,TIM_CHANNEL_2,Tb*4250);
__HAL_TIM_SetCompare(&htim1,TIM_CHANNEL_3,Tc*4250); 
